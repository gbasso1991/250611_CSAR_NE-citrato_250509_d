...
dTdt= ufloat(np.mean([resultados_FF1['pendiente'],resultados_FF2['pendiente'],resultados_FF3['pendiente'],resultados_FF4['pendiente']]),
             np.std([resultados_FF1['pendiente'],resultados_FF2['pendiente'],resultados_FF3['pendiente'],resultados_FF4['pendiente']]))
print(f'Pendiente promedio = {dTdt:.3f} ºC/s')
# %%
...
ax.text(0.1,0.85,f'<m> = {dTdt:.3f} ºC/s',bbox=dict(alpha=0.7),fontsize=14,ha='left',transform=ax.transAxes)
